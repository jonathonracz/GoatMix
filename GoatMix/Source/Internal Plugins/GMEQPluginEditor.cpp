    ...
    fft(processor.snapshotter)
{
    for (size_t i = 0; i < eqs.size(); ++i)
    {
        ...
        GMEQPlugin::EQParams* eqParam = &processor.eqParams[i];
...
GMEQPluginEditor::~GMEQPluginEditor()
{
}

void GMEQPluginEditor::resized()
{
    FlexBox layout;
...
void GMEQPluginEditor::updateSliderOpacities()
{
    for (size_t i = 0; i < eqs.size(); ++i)
    {
...
void GMEQPluginEditor::comboBoxChanged(ComboBox* comboBoxThatHasChanged)
{
    updateSliderOpacities();
}
