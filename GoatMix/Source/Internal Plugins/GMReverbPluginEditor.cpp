...
void GMReverbPluginEditor::resized()
{
    ...
    layout.items.add(FlexItem(graphBox).withMargin(FlexItem::Margin(vertSpace, dynamicSpace, vertSpace, vertSpace)).withFlex(8.0f));
    ...
    freezeMeters.items.add(FlexItem(sliderRoomSize).withMargin(FlexItem::Margin(0.0f, dynamicSpace, 0.0f, 0.0f)).withFlex(1.0f));
    freezeMeters.items.add(FlexItem(sliderDamping).withMargin(FlexItem::Margin(0.0f, dynamicSpace, 0.0f, dynamicSpace)).withFlex(1.0f));
    freezeMeters.items.add(FlexItem(sliderWidth).withMargin(FlexItem::Margin(0.0f, 0.0f, 0.0f, dynamicSpace)).withFlex(1.0f));
    freezeBox.items.add(FlexItem(freezeMeters).withMargin(FlexItem::Margin(0.0f, 0.0f, vertDynamicSpace, 0.0f)).withFlex(6.0f));
    ...
    highPass.items.add(FlexItem(sliderHighPass).withMargin(FlexItem::Margin(0.0f, 0.0f, vertDynamicSpace, 0.0f)).withFlex(6.0f));
    highPass.items.add(FlexItem(buttonHighPass).withFlex(1.0f));

    FlexBox lowPass;
    lowPass.flexDirection = FlexBox::Direction::column;
    lowPass.items.add(FlexItem(sliderLowPass).withMargin(FlexItem::Margin(0.0f, 0.0f, vertDynamicSpace, 0.0f)).withFlex(6.0f));
