...
class GMTooltipManager :
    public MouseListener,
    public Timer
{
public:
    GMTooltipManager(Component& _parent) :
        parent(_parent)
    {
    ...
    {
        virtual ~Listener() {}
        virtual void displayTooltipForComponent(GMTooltipManager* manager, Component* component, String tooltip) {}
        virtual void hideTooltip(GMTooltipManager* manager) {}
    };
