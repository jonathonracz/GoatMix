...
#include "GMTooltipManager.h"

class GMTooltipDisplay :
    public Component,
    public GMTooltipManager::Listener
{
public:
    GMTooltipDisplay(Component& _parent) :
        manager(_parent),
        parent(_parent)
    {
        setAlwaysOnTop(true);
...
private:
    ...
    void displayTooltipForComponent(GMTooltipManager* manager, Component* component, String tooltip) override
    {
        isDirty = true;
        tooltipText = tooltip;
    ...
    void hideTooltip(GMTooltipManager* manager) override
    {
